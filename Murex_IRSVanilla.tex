...
\textbf{Remark.} The derivations above were performed for the \textit{linear} accrual convention.
However, all of the above holds for exponential and yield conventions as well, for some more details see~\cite{Mx.RateCurve}.
