...
\begin{proposition}[Solution of the ODE in Theorem \ref{theo:directionalRS}]
    Consider the ODE:
...
\begin{proposition}[Higher order directional derivatives]
    Let $k \in \{ 1, 2, \ldots \}.$
...
\begin{proposition}[Higher order Frechet]\label{theo:higherFrechet}
...
\begin{proposition}[Duhamel's principle]
